...
import { useCreateBooking } from '@/lib/api/hooks/use-bookings';
...
export default function NewBookingPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push(`/${locale}/bookings/${result.id}`);
    } catch (error) {
    ...
    <div className="p-8">
      <div className="mb-6 flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-gray-700 mt-1 text-base">Create a new booking</p>
        </div>
      </div>
